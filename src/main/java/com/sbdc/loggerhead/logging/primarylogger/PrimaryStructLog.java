...
public final class PrimaryStructLog <T, S extends Struct<T>> extends AbstractPrimaryLog<T, StructLogEntry<T>, StructPublisher<T>> {




public  PrimaryStructLog( String key, LogMode logMode, NetworkTableInstance ntInstance, DataLog dataLog, Struct<T> struct) { 
