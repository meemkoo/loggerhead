...
public final class PrimaryStringLog  extends AbstractPrimaryLog<String, StringLogEntry, StringPublisher> {

public  PrimaryStringLog( String key, LogMode logMode, NetworkTableInstance ntInstance, DataLog dataLog) { 
