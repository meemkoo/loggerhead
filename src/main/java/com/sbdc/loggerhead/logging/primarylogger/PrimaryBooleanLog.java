...
public final class PrimaryBooleanLog  extends AbstractPrimaryLog<Boolean, BooleanLogEntry, BooleanPublisher> {




public  PrimaryBooleanLog( String key, LogMode logMode, NetworkTableInstance ntInstance, DataLog dataLog) { 
