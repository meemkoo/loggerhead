...
public final class PrimaryIntegerArrayLog  extends AbstractPrimaryLog<long[], IntegerArrayLogEntry, IntegerArrayPublisher> {




public  PrimaryIntegerArrayLog( String key, LogMode logMode, NetworkTableInstance ntInstance, DataLog dataLog) { 
