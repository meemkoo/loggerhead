...
public final class PrimaryDoubleLog  extends AbstractPrimaryLog<Double, DoubleLogEntry, DoublePublisher> {




public  PrimaryDoubleLog( String key, LogMode logMode, NetworkTableInstance ntInstance, DataLog dataLog) { 
